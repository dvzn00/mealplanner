...
/**
 * Confirmação para o que não dá para desfazer com um clique.
 *
 * Igual ao `Dialog` na aparência, diferente no comportamento: o foco começa no
 * botão de cancelar, `Esc` cancela, e não há botão de fechar no canto — sair
 * daqui é uma escolha explícita entre duas.
 */
...
function AlertDialogTitle({
  ...
  return (
    <AlertDialogPrimitive.Title
      className={cn("text-base font-semibold text-text-dark", className)}
      {...props}
    />
  );
}
