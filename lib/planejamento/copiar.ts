...
import type { ResultadoDaAcao } from "./schemas";
...
const CAMPOS =
  "dia_da_semana, nome_refeicao, horario, recipe_id, posicao";
...
export async function copiarDia(
  ...
  const { planOrigemId, diaOrigem, semanaDestino, diaDestino } = validado.data;
